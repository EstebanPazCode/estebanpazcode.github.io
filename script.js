...
const locations = [
    ...
    },
    {
        ...
        "text": 'The monster screams "Arg!" as it dies. You gain experience points and find gold.',
            // Cuando mate al mountro agregar una imagen de Felicidades
    },
    {
        name: "lose",
...
function pick (guess){
    ...
    while (numbers.length < 10) {
        numbers.push(Math.floor(Math.random() * 11)) // agrega un numero aleatorio con el metodo push a la variable numbers
    }
